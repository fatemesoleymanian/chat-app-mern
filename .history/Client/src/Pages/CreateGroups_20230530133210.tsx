...
//TODO do this theme and make it work 
type stateType = {
    themeKey: object ,
}
const CreateGroups = () => {
    const lightTheme = useSelector((themeKey:stateType) => themeKey.themeKey);
    console.log(useSelector((themeKey:{themeKey:object|string|boolean}) => themeKey.themeKey))
